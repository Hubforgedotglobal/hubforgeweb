...
- **EvalQR Platform**: External Replit-hosted QR code and link analytics platform (https://evalqr.replit.app/) built for NGOs, evaluators, and social enterprises. Linked from all site navigation menus as a complementary tool in the HubForge ecosystem.